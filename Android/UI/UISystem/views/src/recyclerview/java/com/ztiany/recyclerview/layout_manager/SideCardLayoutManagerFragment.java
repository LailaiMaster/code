...
public class SideCardLayoutManagerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_side_card, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        UniversalAdapter<SlideCardBean> adapter = new UniversalAdapter<SlideCardBean>(requireContext(), cardBeans, R.layout.item_swipe_card) {
            @Override
